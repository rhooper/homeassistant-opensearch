...
async def manager_fixture(
    ...
    with (
        patch("custom_components.opensearch.os_publish_pipeline.Pipeline.Listener") as listener,
        patch("custom_components.opensearch.os_publish_pipeline.Pipeline.Poller") as poller,
        patch("custom_components.opensearch.os_publish_pipeline.Pipeline.Filterer") as filterer,
        patch("custom_components.opensearch.os_publish_pipeline.Pipeline.Formatter") as formatter,
        patch("custom_components.opensearch.os_publish_pipeline.Pipeline.Publisher") as publisher,
    ):
